...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickSignInmain(View view) {
        ...
        if (txtUser.equals("") || txtPass.equals("")) {
            ...
            myAlert.myDialog(this, "มีช่องว่าง", "อยามีช่องว่าง");
        } else {
            checkUser();
        }
    }
    ...
    public class MySynJSON extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                String strURL = "http://csclub.ssru.ac.th/s56122201059/get/php_get_userTABLE.php";
    ...
    private void testAddValue() {
        ...
        objOrderTABLE.addNewOrder("testOfficer", "testDesk", "testFood", "testItem");
